...
const Login = () => {
    const [user_details,set_user_details] = useState({user_id:"",password:""})
    ...
    return(
        <div className = "login_page">
            <div className="main_content">
                ...
                <br/>
                <form>
                    <input type="email" id="email" placeholder="USER ID" onBlur={hide_userMsg} onChange={handle_user_change} onKeyUp={verifyUserid}/><br/>
                    <dd>{userMsg}</dd>
